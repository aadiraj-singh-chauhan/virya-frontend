        ...
        >
          ...
          <span className={styles.arrowWrap} aria-hidden="true">
            <svg className={styles.arrow} width="71" height="59" viewBox="0 0 70.5967 59.2579" fill="none">
              <path d="M38.2573 2.68L27.7167 2.68001L3.59668 29.48L27.7167 56.5779H38.4762" stroke="white" strokeWidth="5.36" />
              <path d="M3.59668 29.4769H70.5967" stroke="white" strokeWidth="5.36" />
            </svg>
          </span>
        </a>
      </div>
